  ...
  <body>    
    <div>      
      ...
      <div class="infocontainer">            
        <form style="height:100%" class="fform" id="fmEdit" method="post">                 
          <label>                    
            <span>                        *Vehicle Reg:              
            </span>                    
            <div id="calendarcolor">
            </div>
            <input MaxLength="200" disabled class="required safe" id="Subject" name="Subject"  type="text" value="<?php echo isset($event)?$event->Subject:"" ?>" />                     
            <input id="colorvalue" disabled name="colorvalue" type="hidden" value="<?php echo isset($event)?$event->Color:"" ?>" />                
          </label>                 
          <label>                    
            <span>*Time:
            </span>                    
            <div>  
              ...
              <input disabled MaxLength="10" class="required date" id="stpartdate" name="stpartdate" type="text" value="<?php echo isset($event)?$sarr[0]:""; ?>" />                       
             <input disabled MaxLength="10" class="required date" id="etpartdate" name="etpartdate"  type="text" value="<?php echo isset($event)?$earr[0]:""; ?>" />                       
          ...
          <label>                    
            ...
            <input disabled MaxLength="200" id="Location" name="Location" style="width:95%;" type="text" value="<?php echo isset($event)?$event->Location:""; ?>" />                 
          </label>                 
          <label>                    
            <span>                        Reason:
            </span>                    
<textarea cols="20" disabled id="Description" name="Description" rows="2" style="width:95%; height:70px">
<?php echo substr(isset($event)?$event->Description:"",3,-4); ?>
</textarea>                
          </label>                
